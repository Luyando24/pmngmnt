      ...
      <header className="sticky top-0 border-b bg-background/80 backdrop-blur-lg supports-[backdrop-filter]:bg-background/60 z-50 shadow-sm">
        <div className="container mx-auto flex items-center justify-between py-4 px-4">
          ...
          <nav className="hidden md:flex items-center gap-8 text-base font-medium">
            ...
            <Link to="#apply" className="text-muted-foreground hover:text-primary transition-colors">Apply Online</Link>
            <Link to="#verify" className="text-muted-foreground hover:text-primary transition-colors">Verify Documents</Link>
            <Link to="#help" className="text-muted-foreground hover:text-primary transition-colors">Help & Support</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-background border-t">
            <nav className="flex flex-col gap-4 p-4">
              <Link to="#services" className="text-muted-foreground hover:text-primary transition-colors py-2">Services</Link>
              <Link to="#apply" className="text-muted-foreground hover:text-primary transition-colors py-2">Apply Online</Link>
              <Link to="#verify" className="text-muted-foreground hover:text-primary transition-colors py-2">Verify Documents</Link>
              <Link to="#help" className="text-muted-foreground hover:text-primary transition-colors py-2">Help & Support</Link>
              <Link to="#news" className="text-muted-foreground hover:text-primary transition-colors py-2">News</Link>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              ...
              <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                  <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    <Link to="/police/cases">Report Now</Link>
                  </Button>
                </div>
              </div>
            {/* Category 2 */}
              <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                  <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    <Link to="/police/suspects">Apply Now</Link>
                  </Button>
                </div>
              </div>
            {/* Category 3 */}
              <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                  <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    <Link to="/immigration/permits">Apply Now</Link>
                  </Button>
                </div>
              </div>
            {/* Category 4 */}
              <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                  <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    <Link to="/police/patrols">View Info</Link>
                  </Button>
                </div>
              </div>
            {/* Category 5 */}
              <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                  <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                    <Link to="/identity/residents">Access Portal</Link>
                  </Button>
                </div>
              </div>
            {/* Category 6 */}
            <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                  <Link to="/identity/verify">Verify Now</Link>
                </Button>
              </div>
            </div>
             {/* Category 7 */}
            ...
            <div className="group relative text-center p-6 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden transform hover:scale-105 hover:-translate-y-2">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary/90 to-primary/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-2xl">
                <Button asChild className="shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                  <Link to="/reports">Access Portal</Link>
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group bg-gradient-to-br from-card to-card/80 rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 transform hover:scale-105 hover:-translate-y-2">
              ...
              <Button asChild variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300 shadow-md hover:shadow-lg">
                <Link to="/police/cases">Report Case</Link>
              </Button>
            </div>
            <div className="group bg-gradient-to-br from-card to-card/80 rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 transform hover:scale-105 hover:-translate-y-2">
              <div className="flex items-center justify-center mb-6">
              ...
              <Button asChild variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300 shadow-md hover:shadow-lg">
                <Link to="/immigration/visas">Apply for Visa</Link>
              </Button>
            </div>
            <div className="group bg-gradient-to-br from-card to-card/80 rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 transform hover:scale-105 hover:-translate-y-2">
              <div className="flex items-center justify-center mb-6">
              ...
              <Button asChild variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300 shadow-md hover:shadow-lg">
                <Link to="/immigration/permits">Apply for Permit</Link>
              </Button>
            </div>
            <div className="group bg-gradient-to-br from-card to-card/80 rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 transform hover:scale-105 hover:-translate-y-2">
              <div className="flex items-center justify-center mb-6">
              ...
              <Button asChild variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300 shadow-md hover:shadow-lg">
                <Link to="/verification">Verify Identity</Link>
              </Button>
            </div>
            <div className="group bg-gradient-to-br from-card to-card/80 rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 transform hover:scale-105 hover:-translate-y-2">
              <div className="flex items-center justify-center mb-6">
              ...
              <Button asChild variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300 shadow-md hover:shadow-lg">
                <Link to="/immigration/passports">Passport Services</Link>
              </Button>
            </div>
            <div className="group bg-gradient-to-br from-card to-card/80 rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 transform hover:scale-105 hover:-translate-y-2">
              <div className="flex items-center justify-center mb-6">
              ...
              <Button asChild variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300 shadow-md hover:shadow-lg">
                <Link to="/immigration/residency">Apply for Residency</Link>
              </Button>
            </div>
          </div>
        </div>
